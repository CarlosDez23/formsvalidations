...
class _LoginPageState extends State<LoginPage> {
  ...
  _doLogin(LoginBloc bloc, BuildContext context) async {
    final Map<String, dynamic> loginResult = await usuarioProvider.doLogin(bloc.emailValue, bloc.passwordvalue);
    if(loginResult.containsValue(false)){
      utils.showAlert(context, 'Login incorrecto');
    }else{
      //Con el pushReplacementNamed lo que hacemos es que ponemos esa ruta como la principal
      //por lo que no se podrá volver al login en este caso
